...
interface AppAuth {
    ...
    @PATCH("/api/user/saveDeviceToken")
    suspend fun updateDeviceToken(@Body requestBody: UpdateToken) : Response<ResponseBody>

    @POST("/api/user/notifications")
    suspend fun sendNotification(@Body requestBody: SendNotificationPostRequest) : Response<ResponseBody>
}
