...
import com.example.travelio.databinding.FragmentTripOrder2Binding
import com.google.android.material.tabs.TabLayoutMediator


class TripOrderFragment : Fragment() {
    private lateinit var binding : FragmentTripOrder2Binding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding =  FragmentTripOrder2Binding.inflate(inflater)
    ...
    object Instance{val instance : TripOrderFragment by lazy { TripOrderFragment() } }
}