...
import com.example.travelio.model.data.Levels
...
class LevelRequests {
    companion object{
        suspend fun getLevelDataList(resources: Resources, isSuccess: (data: Levels?, error: String?, success: Boolean) -> Unit){
            val response = UserApi.user.getLevelsList()
