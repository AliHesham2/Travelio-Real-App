...
class TripRequests {
    companion object{
        suspend fun getTrips(pageNumber: Int, resources: Resources,  city_id:String, location_id:String, minPrice:String, maxPrice:String, fromDate:String, toDate:String,homePage:String, isSuccess: (data: Trips?, error: String?, success: Boolean) -> Unit) {
            val response = AppApi.appData.getTrips(5, pageNumber,city_id, location_id, minPrice, maxPrice,fromDate,toDate,homePage)
